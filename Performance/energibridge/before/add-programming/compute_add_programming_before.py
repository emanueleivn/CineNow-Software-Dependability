...
# Prende tutti i file add-programming_runXX.csv
pattern = os.path.join(FOLDER, "add-programming_run*.csv")
...
out_path = os.path.join(FOLDER, "add-programming_before_summary.csv")
