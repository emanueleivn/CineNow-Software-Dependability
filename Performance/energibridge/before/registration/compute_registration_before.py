...
# Prende tutti i file registration_runXX.csv
pattern = os.path.join(FOLDER, "registration_run*.csv")
...
out_path = os.path.join(FOLDER, "registration_before_summary.csv")
