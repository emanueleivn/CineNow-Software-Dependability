...
VALUES
    (1, 'Conclave', 'Thriller', '14+', 120, LOAD_FILE('/var/lib/mysql-files/conclave.jpg'), "Un thriller ambientato nel mondo della Chiesa e ispirato all'omonimo romanzo di Robert Harris.", true),
    (2, 'Nosferatu', 'Horror', '16+', 135, LOAD_FILE('/var/lib/mysql-files/nosferatulocandina.jpg'), "L'ultimo horror, dal regista di Nosferatu.", true),
    (3, 'Sonic 3', 'Avventura', 'T', 90, LOAD_FILE('/var/lib/mysql-files/sonic.jpg'), 'Il sequel di Sonic 2.', true),
    (4, 'Dove osano le cicogne', 'Commedia', 'T', 95, LOAD_FILE('/var/lib/mysql-files/doveosanolecicogne.jpg'), 'Commedia di Andrea Pintus.', true),
    (5, 'Mufasa', 'Animazione', 'T', 120, LOAD_FILE('/var/lib/mysql-files/mufasalocandina.jpg'), 'La pellicola contemporaneamente prequel e sequel de Il re leone.', true);
